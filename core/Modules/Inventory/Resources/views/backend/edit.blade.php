                        ...
                        <div class="recentCaption">
                            ...
                            <div class="d-flex align-items-center justify-content-between gap-4 mb-4">
                                ...
                                <div class="btn-wrapper d-flex flex-wrap gap-2">
                                    <a href="{{dynamicRoute($product->slug)}}" class="btn btn-success me-2"><i class="lar la-eye icon"></i> {{__('View')}}</a>  <!-- To Product View from Frontend -->
                            ...
                            <div class="featureCap_category">
                                ...
                                <div class="featureCap_category_item d-flex gap-2">
                                    ...
                                    @if($product?->subCategory)
                                        <div class="featureCap_category_item_flex d-flex flex-wrap gap-2">
                                            <span class="pro-btn2">{{$product?->subCategory?->name}}</span>
                                        </div>
                                    @endif
                                </div>
                            </div>
