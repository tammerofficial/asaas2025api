                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item change_priority text-capitalize" data-id="{{$data->id}}" data-val="low" href="#">{{__('low')}}</a>
                                                    <a class="dropdown-item change_priority text-capitalize" data-id="{{$data->id}}" data-val="high" href="#">{{__('high')}}</a>
                                                    <a class="dropdown-item change_priority text-capitalize" data-id="{{$data->id}}" data-val="medium" href="#">{{__('medium')}}</a>
                                                    <a class="dropdown-item change_priority text-capitalize" data-id="{{$data->id}}" data-val="urgent" href="#">{{__('urgent')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item status_change text-capitalize" data-id="{{$data->id}}" data-val="open" href="#">{{__('open')}}</a>
                                                    <a class="dropdown-item status_change text-capitalize" data-id="{{$data->id}}" data-val="close" href="#">{{__('close')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
