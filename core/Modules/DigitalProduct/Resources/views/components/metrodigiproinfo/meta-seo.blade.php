...
{{--            <x-fields.media-upload :id="$metaData?->fb_image" :title="__('General Info Meta Image')" :name="'facebook_image'" :dimentions="'200x200'"/>--}}
            ...
            <x-fields.media-upload-for-metronic :id="$metaData?->fb_image" :title="__('General Info Meta Image')" :name="'facebook_image'" :dimentions="'200x200'"/>
        </div>
...
{{--            <x-fields.media-upload :id="$metaData?->tw_image" :title="__('General Info Meta Image')" :name="'twitter_image'" :dimentions="'200x200'"/>--}}
            ...
            <x-fields.media-upload-for-metronic :id="$metaData?->tw_image" :title="__('General Info Meta Image')" :name="'twitter_image'" :dimentions="'200x200'"/>
        </div>
    </div>
</div>
