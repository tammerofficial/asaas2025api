...
@section('content')
            ...
            <div class="col-md-12">
                <div class="recent-order-wrapper dashboard-table bg-white padding-30">
                    <div class="header-wrap">
                        ...
                        <p>{{__("Manage all integrations from here, you can enable/disable integrations.")}}</p>
                    </div>
                    <div class="plugin-grid">
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="google_analytics_gt4_status"
                                   ...
                                   class="pl-btn pl_active_deactive">{{$method("google_analytics_gt4_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="google_tag_manager_status"
                                   ...
                                   class="pl-btn pl_active_deactive">{{$method("google_tag_manager_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="facebook_pixels_status"
                                   ...
                                   class="pl-btn pl_active_deactive">{{$method("facebook_pixels_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="adroll_pixels_status"
                                   ...
                                   class="pl-btn pl_active_deactive">{{$method("adroll_pixels_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            <div class="thumb-bg-color whatsapp">
                                ...
                                <strong class="whatsapp">{{__("WhatsApp")}}</strong>
                            </div>
                            <p class="plugin-meta">
                                {{__("you can configure WhatsApp into the website.")}}
                            </p>
                            <div class="btn-group-wrap">
                                <a href="#" data-option="whatsapp_status" data-status="{{$method("whatsapp_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("whatsapp_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="messenger_status" data-status="{{$method("messenger_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("messenger_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            <div class="thumb-bg-color twakto">
                                <strong class="twakto">{{__("Twak.to")}}</strong>
                            </div>
                            <p class="plugin-meta">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="twakto_status" data-status="{{$method("twakto_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("twakto_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            <div class="thumb-bg-color crisp">
                                <strong class="crisp">{{__("Crisp")}}</strong>
                            </div>
                            <p class="plugin-meta">
                                {{__("you can configure Crisp into the website.")}}
                            </p>
                            <div class="btn-group-wrap">
                                <a href="#" data-option="crsip_status" data-status="{{$method("crsip_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("crsip_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="tidio_status" data-status="{{$method("tidio_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("tidio_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="captcha_status" data-status="{{$method("captcha_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("captcha_status") == 'on' ? __("Disable") : __("Enable") }}</a>
                        ...
                        <div class="plugin-card">
                            ...
                            <div class="btn-group-wrap">
                                <a href="#" data-option="instagram_status" data-status="{{$method("instagram_status")}}"
                                   class="pl-btn pl_active_deactive">{{$method("instagram_status") == 'on' ? __("Disable") : __("Enable") }}</a>
    ...
    <div class="modal fade" tabindex="-1" id="crsip_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{__("Crisp")}}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{route(route_prefix().'integration')}}" method="post">
                    @csrf
    ...
    <div class="modal fade" tabindex="-1" id="whatsapp_modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{__("WhatsApp")}}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{route(route_prefix().'integration')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label for="#">{{__("WhatsApp Mobile Number With Country Code")}}</label>
                            <input type="text"
    ...
    <script>
        (function ($) {
            ...
            $(document).on("click", '.pl_active_deactive', function (e) {
                ...
                var el = $(this);
                Swal.fire({
                    title: '{{__("Confirm Activation!")}}',
                    text: '{{__("you can deactivate this integration anytime")}}',
                    icon: 'warning',
