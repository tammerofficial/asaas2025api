...
class SiteWayPaymentGatewayAdminPanelController extends Controller
{
    ...
    public function settingsUpdate(Request $request){
        $request->validate([
            ...
            "sitesway_logo" => "nullable|integer",
            "sitesway_status" => "nullable",
        ]);
        ...
        update_static_option("sitesway_logo",$request->sitesway_logo);
        ...
        if(is_null(tenant())) {
            ...
            $jsonModifier->nazmartMetaData->paymentGateway->landlord = $request?->sitesway_landlord_status === 'on';

            $jsonModifier->nazmartMetaData->paymentGateway->tenant = $request?->sitesway_tenant_status === 'on';
            ...
            update_static_option("sitesway_status", $request->sitesway_status);
        }
