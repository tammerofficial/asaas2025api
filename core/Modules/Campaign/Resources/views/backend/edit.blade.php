                            ...
                            <form action="{{ route('tenant.admin.campaign.update') }}" method="POST">
                                ...
                                <div class="row new_campaign mt-3">
                                        ...
                                        <div class="card mb-3" style="border: 1px solid #ddd">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div id="fixed_date_container" class="pt-2" @if(!$campaign->start_date && !$campaign->end_date)  @endif>
                                    ...
                                    <div class="align-items-left col-xl-3 col-md-2">
                                        <button type="submit" class="btn btn-primary mt-2 ">{{ __('Update Campaign') }}</button>
                                    </div>
                                </div>
                            </form>
                        @endcan
