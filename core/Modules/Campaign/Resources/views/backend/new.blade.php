                        ...
                        @can('campaign-create')
                            <form action="{{ route('tenant.admin.campaign.new') }}" method="POST">
                                ...
                                <div class="row new_campaign mt-5">
                                                ...
                                                <div class="card-body-inner mt-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div id="fixed_date_container">
                                                            <input type="date" name="campaign_start_date" id="fixed_from_date" class="form-control mb-2 flatpickr" placeholder="{{ __('From Date') }}" required>
                                                            <br>
                                                            <input type="date" name="campaign_end_date" id="fixed_to_date" class="form-control mb-2 flatpickr" placeholder="{{ __('To Date') }}" required>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="align-items-left col-xl-3 col-md-2">
                                        @can('campaign-create')
                                            <button type="submit" class="btn btn-primary mt-2">{{ __('Create Campaign') }}</button>
                                        @endcan
                                    </div>
                                </div>
                            </form>
