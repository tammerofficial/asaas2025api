...
@section('content')
    @php
        ...
        function isWhitish($hex, $threshold = 0.95): bool
        {
            ...
            // Return whether the luminance is above the very high threshold
                                ...
                                @foreach($product_colors as $product_color)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p style="background-color: {{$product_color->color_code}}; border: {{isWhitish($product_color->color_code) ? '1px solid #c9c9c9' : 'none'}}; width: 30px;height: 20px"></p>
                                        </td>
                                        <td>{{ $product_color->slug }}</td>
                                        <td>
                                            @can('product-color-delete')
                                                <x-table.btn.swal.delete
                                                    :route="route('tenant.admin.product.colors.delete', $product_color->id)"/>
                                            @endcan
