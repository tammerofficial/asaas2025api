                                    ...
                                    <td data-label="Actions">
                                        <div class="action-icon">
                                            <a href="{{ route("tenant.admin.product.trash.restore", $product->id) }}"
                                               class="product-restore btn btn-success btn-sm"><i class="las la-trash-restore-alt"></i> </a>
                                            <a data-product-delete-url="{{ route("tenant.admin.product.trash.delete", $product->id) }}"
                                               href="javascript:void(0)"
                                               class="product-delete btn btn-danger btn-sm"><i class="las la-trash-alt"></i> </a>
                                        </div>
                                    </td>
                                </tr>
                            @empty
