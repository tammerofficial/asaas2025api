                                    ...
                                    <div class="single-blog-two">
                                        ...
                                        <div class="single-blog-two-contents mt-3">
                                            <h4 class="single-blog-two-contents-title mt-3">
                                                <a href="{{dynamicRoute($blog->slug)}}"> {!! purify_html(Str::words($blog->title, 10)) !!} </a>
                                            </h4>
                                            ...
                                            <span class="single-blog-two-contents-tags-item">
                                                ...
                                                @if(count($blog->comments) > 0)
                                                    <span class="single-blog-two-contents-tags-item">
                                                        <a href="{{url(dynamicRoute($blog->slug).'/#comment-area')}}">  {{count($blog->comments)}} {{count($blog->comments) == 1 ? __('Comment') : __('Comments')}} </a>
                                                    </span>
                                                @endif
                                            </div>
                                        </div>
