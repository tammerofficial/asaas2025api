                            ...
                            <div class="single-blog-details-content pt-0">
                                ...
                                <div class="single-blog-details-content-tags mt-3">
                                    <span class="single-blog-details-content-tags-item">
                                        <a href="{{dynamicRoute($blog_post->category?->slug)}}"> {{$blog_post->category?->title}} </a>
                                    </span>
                                ...
                                <div class="col-lg-6 mt-4">
                                    <div class="blog-details-share-content">
                                        ...
                                        <ul class="blog-details-share-social">
                                            {!! single_post_share(dynamicRoute($blog_post->slug), $blog_post->title, $post_img) !!}
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-lg-6 mt-4">
                                                ...
                                                @foreach($all_tags as $tag)
                                                    ...
                                                    @if (!empty($slug))
                                                        <li class="blog-details-tag-list">
                                                            <a class="blog-details-tag-list-item text-capitalize" href="{{dynamicRoute($slug)}}">{{$tag}}</a>
                                                        </li>
                                                    @endif
                                                @endforeach
                                            </ul>
