...
class UpdateCampaignRequest extends FormRequest
{
    ...
    public function rules(): array { return ['title' => ['sometimes', 'required', 'string', 'max:255'], 'status' => ['nullable', 'integer', 'in:0,1'], 'start_date' => ['nullable', 'date'], 'end_date' => ['nullable', 'date', 'after_or_equal:start_date']]; }
