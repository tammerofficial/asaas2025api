            ...
            if (array_key_exists('create_accounts_input', $validated_data) && $validated_data['create_accounts_input'] != null) {
                ...
                if (!$user || 'user_exist' == $user) {
                    ...
                    $user_data = $this->createUserAndDeliveryAddress(
                        compact('username', 'password', 'name', 'email', 'phone', 'country_name', 'city', 'address', 'country_id', 'state_id', 'postal_code')
                    );
...
//        Log::info('event is triggered.');
//        event(new OrderCompleted($order_id, tenant()));
//        Log::info('Pass data:', [
