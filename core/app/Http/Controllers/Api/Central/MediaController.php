...
use App\Http\Requests\Api\Central\Media\UploadMediaRequest;
use App\Http\Requests\Api\Central\Media\BulkDeleteMediaRequest;
use App\Http\Resources\Api\Central\MediaResource;
...
class MediaController extends BaseApiController
{
    ...
    public function index(): AnonymousResourceCollection
    {
        try {
            ...
            $cacheKey = 'central_media_' . request()->get('page', 1);
    ...
    public function show(MediaUploader $media): JsonResponse
    {
        try {
            ...
            $cachedMedia = $this->remember("central_media_{$media->id}", 600, function () use ($media) {
                return $media;
            });
    ...
    public function update(Request $request, MediaUploader $media): JsonResponse
    {
        ...
        // Clear related cache
        $this->clearCache('central_media*');
        $this->clearCache("central_media_{$media->id}*");
    ...
    public function destroy(MediaUploader $media): JsonResponse
    {
        ...
        // Clear related cache
        $this->clearCache('central_media*');
        $this->clearCache("central_media_{$mediaId}*");
