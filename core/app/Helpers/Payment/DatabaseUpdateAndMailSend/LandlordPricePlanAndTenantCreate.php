    ...
    public static function update_tenant($payment_data)
    {
        ...
        try {
            \DB::table('tenants')->where('id', $tenant->id)->update([
                ...
                'expire_date' => $payment_log->status == 'trial' ? $payment_log->expire_date : get_plan_left_days_count($payment_log->package_id, $tenant->expire_date, $payment_log->start_date),
