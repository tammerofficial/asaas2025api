...
//            }
            if (is_object($themeInformation) && property_exists($themeInformation, 'slug')) {
                if ($themeInformation->slug == 'default') {
                    continue;
                }
...
//            dd($dire);
            ...
            $currFolderName = pathinfo($dire, PATHINFO_BASENAME);
            $themeInformation = $this->getIndividualThemeData($currFolderName);
//dd($currFolderName, $themeInformation);
...
//                }
//            }
            if ($themeInformation && property_exists($themeInformation, 'status') && $themeInformation->status) {
                if (property_exists($themeInformation, 'slug')) {
                    if ($themeInformation->slug == 'default') {
                        continue;
                    }
