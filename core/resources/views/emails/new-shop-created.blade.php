...
<div class="mail-container">
    ...
    <div class="main-content-wrap">
        <p>{{__('Hello')}}</p>
            <p>{{__('Thank you for purchasing our subscription plan, your website is ready')}}</p>
        ...
        <table style="margin-top: 15px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <small style="display: block;">{{__('you can access in your website admin panel from your user dashboard')}}</small><br>
                    </td>
                </tr>
        </table>
    </div>
