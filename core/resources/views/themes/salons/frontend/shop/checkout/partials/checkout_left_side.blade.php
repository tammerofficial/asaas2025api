                        ...
                        <div class="checkout-form-flex">
                            ...
                            <div class="single-input mt-4">
                                ...
                                <input type="text"
                                       ...
                                       name="state"
                                       id="state"
                                       value="@auth('web'){{$billing_info ? $billing_info->state->name : (!empty(auth('web')->user()?->state->name) ? auth('web')->user()?->state->name : old('state'))}}@else{{old('state')}}@endauth" {{$readonly}}>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('City/Town')}} </label>
                                <input class="form--control" type="text"
                                       placeholder="{{__('Type City/Town')}}"
                                       name="city"
