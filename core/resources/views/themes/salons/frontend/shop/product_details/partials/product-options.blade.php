<div class="single-shop-details-wrapper">
    ...
    <div class="status-details d-flex align-items-center pt-2">
        <span class="status-details-title fw-500 me-5"> {{__('Status')}} </span>
        <a id="{{ $quickView ? "quick_view_" : "" }}stock"
...
{{--$('.single-shop-details-wrapper .quantity-area').hide(); .show();--}}
    @php
        $final_price = calculatePrice($sale_price, $product);
    @endphp

    <div class="price-update-through pt-2">
    ...
    <div class="value-input-area mt-4">
        @if($productSizes->count() > 0 && !empty(current(current($productSizes))))
            <div
                class="value-input-area single-input-list pt-2 size_list d-flex align-items-center justify-content-left {{ $quickView ? "quick-view-value-input-area" : "" }}">
        ...
        @if($productColors->count() > 0 && current(current($productColors)))
            <div
                class="value-input-area single-input-list pt-2 color_list d-flex align-items-center justify-content-left {{ $quickView ? "quick-view-value-input-area" : "" }}">
                    <span class="input-title fw-500 color-heading">
        ...
        @foreach($available_attributes as $attribute => $options)
            <div
                class="value-input-area single-input-list pt-2 attribute_options_list d-flex align-items-center justify-content-left {{ $quickView ? "quick-view-value-input-area" : "" }}">
    ...
    <div class="wishlist-share social_share_parent pt-4">
        @php
    ...
    <div class="shop-details-stock shop-border-top pt-4">
        ...
        <div class="delivery-options delivery-parent pt-2">
        ...
        <div class="details-checkout-shop shop-border-top pt-2">
