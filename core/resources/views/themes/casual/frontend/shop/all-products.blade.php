...
@section('scripts')
    <script>
        $(function () {
            ...
            $(document).on('click', '.ad-values, .price-search-btn', function (e) {
                let currentPage = $(".pagination .page-item .page-link.active").attr("data-page");
                filter_product_request(currentPage);
            });

            $(document).on('click', '.category-lists .list', function (e) {
                e.preventDefault();

                $('.category-lists .list').removeClass('active');
                $('.category-lists .item').removeClass('active');
            ...
            function filter_product_request(page = null, sort = null) {
                ...
                let category_slug = $('.category-lists .item.active').closest('li').data('slug');
