                                ...
                                @if($product->inventory_detail_count < 1)
                                    <div class="btn-wrapper" data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <a href="javascript:void(0)" data-product_id="{{ $product->id }}"
                                           class="add-to-cart-btn cmn-btn cmn-btn-bg-1 cmn-btn-small radius-0"> {{__('Add to Cart')}} </a>
                                    </div>
                                    <div class="icon-list wishlist-btn" data-bs-toggle="tooltip" data-bs-placement="top"
                                         title="{{__('Add to Wishlist')}}">
                                        <a class="add-to-wishlist-btn icon cart-loading"
                                           data-product_id="{{ $product->id }}" href="javascript:void(0)"> <i
                                                class="lar la-heart"></i>
                                        </a>
                                    </div>
                                    <div class="icon-list compare-btn" data-product_id="{{$product->id}}"
                                ...
                                @else
                                    <div class="btn-wrapper" data-bs-toggle="tooltip" data-bs-placement="top"
                                        ...
                                        <a href="javascript:void(0)"
                                           class="product-quick-view-ajax cmn-btn cmn-btn-bg-2 radius-0"
