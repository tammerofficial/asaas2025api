                    ...
                    <form action="{{route('tenant.shop.checkout')}}" method="POST" class="checkout-form" enctype="multipart/form-data">
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('First Name')}}<x-fields.mandatory-indicator/> </label>
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Mobile Number')}}<x-fields.mandatory-indicator/> </label>
                            ...
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('ZIP / PIN Code')}}<x-fields.mandatory-indicator/> </label>
                                <input class="form--control" type="text" placeholder="{{__('ZIP / PIN Code')}}" name="postal_code" maxlength="6" value="@auth('web'){{$billing_info ? $billing_info->postal_code : auth('web')->user()?->postal_code}}@else{{old('postal_code')}}@endauth" {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Country')}}<x-fields.mandatory-indicator/> </label>
                            ...
                            <div class="single-input mt-4">
                                ...
                                <input type="text"
                                       ...
                                       name="state"
                                       id="state"
                                       value="@auth('web'){{$billing_info ? $billing_info->state : (!empty(auth('web')->user()?->state) ? auth('web')->user()?->state : old('state'))}}@else{{old('state')}}@endauth" {{$readonly}}"
                                {{ $readonly }}>
                            </div>
                            <div class="single-input mt-4">
                                ...
                                <input type="text"
                                       ...
                                       name="city"
                                       id="city"
                                       value="@auth('web'){{$billing_info ? $billing_info->city : (!empty(auth('web')->user()?->city) ? auth('web')->user()?->city : old('city'))}}@else{{old('city')}}@endauth"
                                    {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Address')}}<x-fields.mandatory-indicator/> </label>
