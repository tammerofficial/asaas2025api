...
@section('scripts')
    ...
    <script>
        $(function (){
            ...
            $(document).on('change', '.shift-another-country', function (e){
                ...
                getCountryStateBasedTotal(country);
            });

            $(document).on('change', '.billing_address_country', function (e){
            ...
            $(document).on('click', 'input[name=shipping_method]', function (){
                ...
                if (total !== undefined)
                {
                    getShippingMethodBasedTotal(shipping_method, $('.coupon-country').val(), total);
                }
            });

            function getShippingMethodBasedTotal(shipping_method ,country, total) {
            ...
            function getCountryStateBasedTotal(country) {
                $.ajax({
