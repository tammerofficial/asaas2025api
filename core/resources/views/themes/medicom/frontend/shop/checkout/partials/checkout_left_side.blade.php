                        ...
                        <div class="checkout-form-flex">
                            ...
                            <div class="single-input mt-4">
                                ...
                                <input type="text"
                                       ...
                                       placeholder="{{__('Type State')}}" name="state"
                                       id="state"
                            ...
                            <div class="single-input mt-4">
                                ...
                                <input class="form--control" type="text"
                                       placeholder="{{__('Type City/Town')}}" name="city"
                                       value="@auth('web'){{$billing_info ? $billing_info->city : (!empty(auth('web')->user()?->city) ? auth('web')->user()?->city : old('city'))}}@else{{old('city')}}@endauth" {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
