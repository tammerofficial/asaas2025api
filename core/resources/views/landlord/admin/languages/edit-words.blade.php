            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-info mt-3">{{__('Select any source text to translate it, then enter your translated text in textarea hit update')}}</p>
                        <p class="text-primary">{{__('Landlord have to translate tenant text or add new translated text from here')}}</p>
