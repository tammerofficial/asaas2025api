                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Package Name :')}}</strong>
                                            <span class=" mx-2">{{$order->package_name}}</span><br><br>
                                        </div>

                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Package Price :')}}</strong>
                                            <span
                                                class=" mx-2">{{amount_with_currency_symbol($order->package_price)}}</span><br><br>
                                        </div>

                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Payment Gateway :')}}</strong>
                                            <span
                                                class=" mx-2 text-capitalize">{{str_replace('_',' ',$order->package_gateway)}}</span><br><br>
                                        </div>

                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Order User Name :')}}</strong>
                                            <span class=" mx-2"> {{$order->name}}</span><br><br>
                                        </div>

                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Order User Email :')}}</strong>
                                            <span class=" mx-2">{{$order->email}}</span><br><br>
                                        </div>

                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Subdomain :')}}</strong>
                                            <span class=" mx-2">{{$order->tenant_id}}</span><br><br>
                                        </div>

                                        <div class="parent d-flex justify-content-start">
                                            <strong class="">{{__('Order Date :')}}</strong>
                                            <span
                                                class=" mx-2">{{date_format($order->created_at,'d M Y')}}</span><br><br>
                                        </div>
                                        ...
                                        @if(!empty($all_custom_fields))
                                            ...
                                            @foreach($all_custom_fields ?? [] as $key=> $field)
                                                <div class="att mb-2 mt-2">
                                                    <strong class="">{{ ucfirst($key) . ' : ' }}</strong>
                                                    <span>{{$field}}</span><br>
                                                </div>
                                            @endforeach
                                        @endif
                                        ...
                                        @if($order->status != 'trial')
                                            ...
                                            @if($order->transaction_id)
                                                    <div class="parent d-flex justify-content-start">
                                                        <strong class="">{{__('Transaction ID :')}}</strong>
                                                        <span class=" mx-2">
                                            ...
                                            @if(!is_dir($attachments) && file_exists($attachments))
                                                <div class="parent d-flex justify-content-start">
                                                    <strong class="">{{__('Attachment :')}}</strong>
                                                    <span class=" mx-2">
