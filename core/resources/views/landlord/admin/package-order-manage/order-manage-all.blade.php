...
<th>{{ __('Payer details:') }}</th>
                                    <th>{{__('Package Gateway')}}</th>

                                    <th>{{__('Order Date')}}</th>
{{--                                    <th>{{__('Last renew Date')}}</th>--}}
...
{{--                                    @dd($data)--}}
                                    <tr>
                                        ...
                                        <td>{{ $data->id }}</td>
                                        <td>
                                            {{ __('Package name:'.$data->package_name) }}
                                                <br>
                                            {{ __('Package price:'.amount_with_currency_symbol($data->package_price)) }}
                                        </td>
                                        <td>
                                            {{ __('Payer name:'. $data->name) }}
                                            <br>
                                            {{ __('Payer email:'. $data->email) }}
                                            <br>
                                            {{ __('Subdomain:'. $data->tenant_id) }}
                                        </td>
...
{{--                                        <td>{{date('d-m-Y',strtotime($data->expire_date))}}</td>--}}
                                        ...
                                        <td>
                                            ...
                                            @if(($data->renew_status != 0) || ($data->is_renew != 0))
                                                {{__('First order: '). date('d-m-Y',strtotime($data->created_at))}} <br>
                                                {{__('Renewal order: '). date('d-m-Y',strtotime($data->start_date)) }}
                                            @else
