...
{{--                        </div>--}}
                        <div class="form-group">
                            <label for="message">{{ __('Message') }}</label>
{{--                            <input  name="message">--}}
{{--                            <div class="summernote" data-gramm="false"></div>--}}
        ...
        (function ($){
            ...
            $(document).ready(function () {
                ...
                $(document).on('click', '.send_mail_to_tenant_btn', function() {
                    ...
                    // Reset summernote content when opening modal
                    form.find('textarea.summernote').summernote('reset');
                });
                ...
                $('textarea.summernote').summernote({
                    placeholder: "{{__('Start writing your story here... 🌟 Feel free to express your ideas, add images, and make it your own!')}}",
                    tabsize: 2,
                    height: 300, // Increased for better video preview
                    toolbar: [
                        ['style', ['style']],
                        ['font', ['bold', 'underline', 'clear']],
                        ['color', ['color']],
