                ...
                <div class="dashboard-address-details">
                    ...
                    <div class="single-dashboard-input">
                        <div class="single-info-input single-input margin-top-30">
                            ...
                            <input class="form--control" id="phone" type="number" name="phone" placeholder="{{__('Type Your Number')}}" value="{{$user_details->mobile}}">
                        </div>

                        <div class="single-info-input margin-top-30">
                            <label class="info-title"> {{__('Company')}} </label>
                            <input class="form--control" type="text" name="company" placeholder="{{__('Type Your Company Name')}}" value="{{$user_details->company}}">
                        </div>
                    </div>
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
                        ...
                        <div class="single-info-input margin-top-30">
                            ...
                            <input type="text"
                                   ...
                                   name="state"
                                   id="state"
                                   value="@auth('web'){{$user_details ? $user_details->state : (!empty(auth('web')->user()?->state) ? auth('web')->user()?->state : old('state'))}}@else{{old('state')}}@endauth"
                           >
                        </div>
                        ...
                        <div class="single-info-input margin-top-30">
                            ...
                            <input type="text"
                                   ...
                                   name="city"
                                   id="city"
                                   value="@auth('web'){{$user_details ? $user_details->city : (!empty(auth('web')->user()?->city) ? auth('web')->user()?->city : old('city'))}}@else{{old('city')}}@endauth">
                        </div>
                    </div>
                    <div class="single-dashboard-input">
                        <div class="single-info-input margin-top-30">
