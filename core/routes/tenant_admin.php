...
//dd($path);
    ...
    Route::post('/products/import', [ProductImportController::class, 'import'])->name('products.import.post');
    Route::get('/products/download-sample-csv', [ProductImportController::class, 'downloadSampleCSV'])->name('products.download.sample');
    Route::get('/products/download-empty-template', [ProductImportController::class, 'downloadEmptyTemplate'])->name('products.download.empty');
