...
class ProductTypeList extends PageBuilderBase
{
    ...
    {
        return 'Tenant/themes/bookpoint/home/product_type_list.jpg';
    }
    ...
    public function admin_render()
    {
        ...
        $categories = DigitalCategories::where(['status' => 1])->get()->mapWithKeys(function ($item){
    ...
    public function frontend_render()
    {
        ...
        if (!empty($categories_id))
        {
            ...
            $products_id = DigitalProductCategories::whereIn('category_id', $categories_id)->pluck('product_id')->toArray();
