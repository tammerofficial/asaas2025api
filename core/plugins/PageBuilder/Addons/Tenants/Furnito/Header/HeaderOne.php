...
namespace Plugins\PageBuilder\Addons\Tenants\Furnito\Header;
...
class HeaderOne extends PageBuilderBase
{
    ...
    {
        return 'Tenant/themes/furnito/home/header.jpg';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.furnito.header.header-one',$data);
