...
class CategoriesSlider extends PageBuilderBase
{
    ...
    {
        return 'Tenant/themes/furnito/home/categories_slider.jpg';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.furnito.common.categories-slider',$data);
    ...
    {
        return __('Furnito: Categories Slider');
    }
}
