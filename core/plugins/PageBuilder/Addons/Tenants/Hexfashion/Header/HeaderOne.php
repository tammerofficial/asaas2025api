...
namespace Plugins\PageBuilder\Addons\Tenants\Hexfashion\Header;
...
class HeaderOne extends PageBuilderBase
{
    ...
    {
        return 'Tenant/themes/hexfashion/home/header.jpg';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.hexfashion.header.header-one',$data);
    ...
    {
        return __('HexFashion: Header (01)');
    }
