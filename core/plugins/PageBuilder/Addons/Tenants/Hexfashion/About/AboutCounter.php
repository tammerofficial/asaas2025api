...
namespace Plugins\PageBuilder\Addons\Tenants\Hexfashion\About;
...
class AboutCounter extends PageBuilderBase
{
    ...
    {
        return 'Tenant/themes/hexfashion/about/about_counter.jpg';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.hexfashion.about.number_counter',$data);

    }

    public function addon_title()
    {
        return __('Theme HexFashion: About Counter (01)');
    }
}
