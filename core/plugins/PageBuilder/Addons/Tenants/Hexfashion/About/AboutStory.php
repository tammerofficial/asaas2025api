...
class AboutStory extends PageBuilderBase
{
    ...
    {
        return 'Tenant/themes/hexfashion/about/about_story.jpg';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('tenant.hexfashion.about.about_story',$data);
    }
    ...
    {
        return __('Theme HexFashion: About Story (01)');
    }
}
