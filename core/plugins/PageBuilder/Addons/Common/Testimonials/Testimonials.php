...
namespace Plugins\PageBuilder\Addons\Common\Testimonials;
...
class Testimonials extends PageBuilderBase
{
    ...
    {
        return 'Common/testimonials.jpg';
    }
    ...
    {
        $repeater_data = $this->setting_item('testimonials_repeater');
        ...
        return self::renderView('common.testimonials', $data);
    }
