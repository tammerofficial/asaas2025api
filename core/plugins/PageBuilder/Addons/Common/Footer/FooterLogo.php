...
class FooterLogo extends PageBuilderBase
{
    public function preview_image()
    {
        return 'Common/Footer/footer-logo.jpg';
    }
    ...
    public function frontend_render()
    {
        ...
        return self::renderView('common.footer.footer-logo', $data);
    }
