...
!function (t, e) {
    ...
    return function (t) {
        ...
        0: function (e, n) {
            ...
            var C = {
                head: b, last: k, initial: function (t) {
                    return t.slice(0, t.length - 1)
                }, tail: y, prev: function (t, e) {
                    if (t && t.length && e) {
                        var n = t.indexOf(e);
            ...
            var s = function () {
                ...
                return e = t, (n = [{
                    key: "show", value: function () {
                        ...
                        var o = this.$tooltip, r = this.options.title || t.attr("title") || t.data("title"),
                            a = this.options.placement || t.data("placement");
                        o.addClass(a), o.find(".note-tooltip-content").text(r), o.appendTo(this.options.target);
                        var s = t.outerWidth(), l = t.outerHeight(), c = o.outerWidth(), u = o.outerHeight();
                        "bottom" === a ? o.css({
                            top: e.top + l,
                            left: e.left + (s / 2 - c / 2)
                        }) : "top" === a ? o.css({
                            ...
                            top: e.top + (l / 2 - u / 2),
                            left: e.left - c
                        }) : "right" === a && o.css({top: e.top + (l / 2 - u / 2), left: e.left + s}), o.addClass("in")
                    }
                }, {
                    key: "hide", value: function () {
                        var t = this;
            ...
            var c = function () {
                ...
                return e = t, (n = [{
                    ...
                    key: "show", value: function () {
                        ...
                        var t = this.$button.next(), e = t.offset(), n = t.outerWidth(), o = i()(window).width(),
            ...
            var h = function () {
                ...
                C = r.a.create('<button type="button" class="note-btn" tabindex="-1">', (function (t, e) {
                    e && e.tooltip && (t.attr({"aria-label": e.tooltip}), t.data("_lite_tooltip", new s(t, {
                        title: e.tooltip,
                        container: e.container
                    })).on("click", (function (t) {
                        i()(t.currentTarget).data("_lite_tooltip").hide()
                    }))), e.contents && t.html(e.contents), e && e.data && "dropdown" === e.data.toggle && t.data("_lite_dropdown", new u(t, {container: e.container})), e && e.codeviewKeepButton && t.addClass("note-codeview-keep")
                    ...
                    return w([C({
                        ...
                        tooltip: t.tooltip,
                        data: {toggle: "dropdown"}
                    }), x([w({className: "note-align", children: t.items[0]}), w({
                        className: "note-list",
                        children: t.items[1]
                    })])]).render()
                }, I = function (t) {
                    return w([C({
                        ...
                        callback: function (e) {
                            e.find(".note-dimension-picker-mousecatcher").css({
                                ...
                                !function (t, e, n) {
                                    var o, r = i()(t.target.parentNode), a = r.next(),
                                    ...
                                    var d = Math.ceil(o.x / 18) || 1, h = Math.ceil(o.y / 18) || 1;
                                    l.css({
                                        width: d + "em",
                                        height: h + "em"
                                    }), s.data("value", d + "x" + h), d > 3 && d < e && c.css({width: d + 1 + "em"}), h > 3 && h < n && c.css({height: h + 1 + "em"}), a.html(d + " x " + h)
                                }(e, t.col, t.row)
                            }))
                        }
                    }).render()
                    ...
                    return w({
                        ...
                        children: [C({
                            ...
                            click: function (n) {
                                var o = i()(n.target), r = o.data("event"), a = o.data("value"),
